...
const projects: Project[] = [
  {
    ...
    description: 'An AI-powered trading bot that uses machine learning to analyze market trends and make trades.',
  },
  {
    ...
    description: 'A desktop application for image processing tasks like filtering, resizing, and format conversion.',
  },
  {
    ...
    tags: ['Python'],
    description: 'A python package that provides weather data and forecasts using various APIs.',  
  },  
  {
    title: 'Let\'s Beano',
  ...
  },
  {
    ...
    description: 'A machine learning model to detect Alzheimer\'s disease using brain scans.',
  },
  {
    ...
    tags: ['Python', 'Machine Learning'],
    description: 'A machine learning model to analyze water quality based on various parameters.',
  },
  {
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-10">
          {allTags.map(tag => (
            <button
              ...
              className={`inline-block px-8 py-3 rounded-full font-semibold bg-gradient-to-r from-pink-400 via-purple-500 to-indigo-500 text-lg md:text-xl
                  ...
                  <div className="flex gap-4">
                    <span className="w-6 h-6 text-white hover:text-cyan-400">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 3.75h2.25A2.25 2.25 0 0121 6v12a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18V6A2.25 2.25 0 016 3.75H8.25" />
                        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 3.75L8.25 12M8.25 12h7.5" />
                      </svg>
                    </span>
                    {proj.live && (
                      <span className="w-6 h-6 text-white hover:text-cyan-400">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5M3 12a9 9 0 1118 0 9 9 0 01-18 0z" />
                        </svg>
                      </span>
                    )}
                  </div>
